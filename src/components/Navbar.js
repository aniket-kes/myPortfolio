    ...
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a href="https://dribbble.com" target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 ml-3 mr-2">
            <DribbbleIcon />
          </motion.a>
        ...
        isOpen ?
          ...
          >
            ...
            <nav className="flex items-center justify-center flex-wrap mt-2">
              ...
              <motion.a href="https://github.com" target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1 bg-light rounded-full dark:bg-dark">
                <GithubIcon />
              </motion.a>
              <motion.a href="https://linkedin.com" target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1">
                <LinkedInIcon />
              </motion.a>
              <motion.a href="https://pinterest.com" target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1 bg-light rounded-full">
                <PinterestIcon />
              </motion.a>
