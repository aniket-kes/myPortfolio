...
import images1 from "../../public/images/projects/crypto-screener.jpg"
...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
    return (
        <article className='w-full flex items-center justify-between rounded-3xl border-4 border-solid border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'>
...
const Project = ({ title, type, img, link, github }) => {
    return (
        <article className='w-full flex flex-col items-center justify-center rounded-2xl border-4 border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light xs:p-4'>
...
const projects = () => {
    return (
        <>
            <Head>
                <title>Aniket Kesarwani - Projects Page</title>
